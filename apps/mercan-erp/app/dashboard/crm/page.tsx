...
export default async function CRMPage() {
  ...
  return (
    <div className="h-[calc(100vh-24px)] flex flex-col overflow-hidden px-4 gap-3 bg-zinc-950">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-2.5 bg-zinc-900 p-2.5 rounded-[4px] shadow-sm border border-zinc-800 shrink-0">
        <div className="flex items-center gap-4">
          <div className="w-8 h-8 bg-black border border-zinc-800 flex items-center justify-center text-red-500 shadow-lg shrink-0 rounded-[4px]">
            <Layers size={16} />
          </div>
          <div>
