...
export default function CMSPage() {
  return (
    <div className="p-8 space-y-4 font-medium italic">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        ...
        <div className="flex items-center gap-3">
          <Link
            href="/"
            target="_blank"
            className="px-8 py-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-[4px] text-[10px] font-black uppercase tracking-widest flex items-center gap-3 hover:bg-slate-50 dark:hover:bg-slate-800 transition-all shadow-sm active:scale-95 group"
          >
            <Globe
              size={14}
      ...
      <div className="bg-white dark:bg-slate-950 text-slate-900 dark:text-white p-8 rounded-[4px] border border-slate-200 dark:border-slate-800 relative overflow-hidden shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {CMS_MODULES.map((module) => (
          <Link
            key={module.title}
            href={module.href}
            className="group bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-8 rounded-[4px] shadow-sm hover:shadow-md hover:border-emerald-600/50 transition-all duration-500 relative overflow-hidden flex flex-col justify-between min-h-[220px]"
          >
