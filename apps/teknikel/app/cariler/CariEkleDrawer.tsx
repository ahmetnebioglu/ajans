...
import { Drawer, Form, Input, Button, Row, Col, Space, App, Divider, Typography } from 'antd';
import { PlusOutlined, UserOutlined, BankOutlined, PhoneOutlined, MailOutlined, HomeOutlined } from '@ant-design/icons';
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Input placeholder="Örn: ABC Ticaret Ltd. Şti." prefix={<BankOutlined className="text-slate-300" />} />
        </Form.Item>

        <Row gutter={16}>
          <Col span={12}>
            <Form.Item name="yetkili" label="Yetkili">
              <Input placeholder="Ad Soyad" prefix={<UserOutlined className="text-slate-300" />} />
            </Form.Item>
          </Col>
          <Col span={12}>
        ...
        <Row gutter={16}>
          <Col span={12}>
            <Form.Item name="tel" label="Telefon">
              <Input placeholder="Sabit Hat" prefix={<PhoneOutlined className="text-slate-300" />} />
            </Form.Item>
          </Col>
          <Col span={12}>
            <Form.Item name="cep" label="Cep Telefonu">
              <Input placeholder="Gsm No" prefix={<PhoneOutlined className="text-slate-300" />} />
            </Form.Item>
          </Col>
        </Row>

        <Form.Item name="mail" label="E-posta Adresi">
          <Input placeholder="info@company.com" prefix={<MailOutlined className="text-slate-300" />} />
        </Form.Item>
        ...
        <div className="bg-slate-50 dark:bg-slate-800/50 p-4 rounded-lg border border-slate-100 dark:border-slate-800 mt-6">
          <Text className="text-[11px] text-slate-500">
            * Kayıt işlemi tamamlandığında veriler doğrudan Bilsoft Ön Muhasebe sistemine aktarılır ve otomatik bir cari kodu (CXXXXXX) atanır.
          </Text>
        </div>
      </Form>
    </Drawer>
