...
import { Card, Descriptions, Tag, Button, Divider, Row, Col, Flex } from "antd";
import {
  ArrowLeftOutlined,
  UserOutlined,
  PhoneOutlined,
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      <div className="mb-6 flex items-center justify-between">
        ...
        <Tag
          color={safeCari.grup === "VIP" ? "gold" : "blue"}
          className="font-bold"
        >
          {safeCari.grup || "GENEL"}
        </Tag>
          ...
          <Flex vertical gap={24}>
            ...
            >
              <Descriptions column={1} bordered size="small">
                ...
                <Descriptions.Item label="Cari Kod">
                  {safeCari.cariKod}
                </Descriptions.Item>
            ...
            >
              <Descriptions column={1} bordered size="small">
                <Descriptions.Item label="İl / İlçe">
                  {safeCari.faturaIlce} / {safeCari.faturaIl}
                </Descriptions.Item>
                <Descriptions.Item label="Fatura Adresi">
                  {safeCari.faturaAdres || "-"}
                </Descriptions.Item>
                <Descriptions.Item label="Sevk Adresi">
                  {safeCari.sevkAdres || "-"}
                </Descriptions.Item>
          ...
          <Flex vertical gap={24}>
            ...
            >
              <div className="text-center py-4">
                ...
                <div
                  className={`text-2xl font-black ${safeCari.bakiye < 0 ? "text-rose-500" : "text-emerald-500"}`}
                >
                  {new Intl.NumberFormat("tr-TR", {
                    style: "currency",
                    currency: "TRY",
                  }).format(safeCari.bakiye || 0)}
                </div>
              </div>
                ...
                <Descriptions.Item label="Risk Limiti">
                  {safeCari.riskLimiti
                    ? new Intl.NumberFormat("tr-TR", {
                        style: "currency",
                        currency: "TRY",
                      }).format(safeCari.riskLimiti)
                    : "-"}
                </Descriptions.Item>
                <Descriptions.Item label="Vade Günü">
                  {safeCari.varsayilanVadeGunu || "-"}
                </Descriptions.Item>
              </Descriptions>
            </Card>
            ...
            <Card
              title={
                <div className="flex items-center gap-2">
                  <InfoCircleOutlined /> Notlar
                </div>
              }
              className="shadow-sm"
            >
              <div className="text-sm text-slate-600 dark:text-slate-400 italic">
                {safeCari.cariaciklama ||
                  safeCari.aciklama ||
                  "Not bulunmuyor."}
              </div>
            </Card>
