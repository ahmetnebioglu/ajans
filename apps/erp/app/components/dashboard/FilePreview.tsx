        ...
        <div className="p-6 border-b border-slate-100 dark:border-zinc-800 flex items-center justify-between bg-white/80 dark:bg-zinc-900/80 backdrop-blur-md sticky top-0 z-10 font-medium italic">
          <div className="flex items-center gap-4 flex-1 min-w-0">
            ...
            <div className="min-w-0">
              <h3 className="text-xl font-black text-slate-900 dark:text-white tracking-tighter uppercase truncate leading-none mb-1">
                {file?.title}
              </h3>
              <p className="text-[10px] text-slate-400 dark:text-zinc-500 font-bold uppercase tracking-widest truncate">
                PANEL ÖN İZLEME SİSTEMİ
              </p>
            </div>
          </div>
          ...
          {hasNoFile ? (
            <div className="text-center p-12 space-y-6 max-w-sm italic">
              ...
              <div className="space-y-2">
                <h4 className="text-2xl font-black italic tracking-tighter text-slate-900 dark:text-white uppercase">
            ...
            <div className="text-center p-12 space-y-6 max-w-sm italic">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-slate-400 dark:text-zinc-500 font-bold uppercase leading-relaxed tracking-widest">
                  BU DOSYA TÜRÜ İÇİN ÖN İZLEME DESTEKLENMİYOR.
                </p>
              </div>
              <a
                href={file?.fileUrl}
