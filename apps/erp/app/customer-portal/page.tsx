    ...
    <div className="space-y-6 animate-in fade-in duration-700 italic font-medium">
      ...
      <div className="bg-white dark:bg-zinc-900 rounded-[4px] border border-slate-200 dark:border-zinc-800 shadow-2xl overflow-hidden">
        ...
        <Table 
          ...
          dataSource={[
            { key: '1', date: '27.04.2026 10:30', action: 'Rapor Görüntüleme', workspace: 'Mercan Grup Lojistik', status: 'Tamamlandı' },
            { key: '2', date: '26.04.2026 15:45', action: 'Profil Güncelleme', workspace: 'Genel', status: 'Başarılı' },
            { key: '3', date: '25.04.2026 09:12', action: 'Firma Bilgi Güncelleme', workspace: 'Tekno Lojistik Ltd.', status: 'Onaylandı' },
          ]}
          pagination={false}
