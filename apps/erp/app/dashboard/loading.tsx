  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] p-6 space-y-4">
      ...
      <div className="space-y-2 text-center">
        <p className="text-[10px] font-black uppercase tracking-[0.4em] text-indigo-500 animate-pulse italic">Sistem Hazırlanıyor</p>
        <p className="text-[8px] font-bold uppercase tracking-widest text-slate-400 italic">Lütfen bekleyin...</p>
      </div>
    </div>
  );
}
